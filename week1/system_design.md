...
- Что будем считать успехом итерации с точки зрения бизнеса - достигнут описанный результат, при несоответствии ожиданий внесены правки.  
