...
- Бизнес-цель - увеличить конверсию в заказ, средний чек и частоту покупок путем релевантных персонализированных рекомендаций. 
...
- Стэк-технологии - Python, Flask, Docker 
- Данные - Используются реальные замаскированные данные одного из действующих маркетплейсов. Данные были собраны по определенному временому срезу и помещены в csv-файл.
...
- Для обучения и валидации second-stage модели 
