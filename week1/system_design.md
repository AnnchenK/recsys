...
- Что будем считать успехом итерации с точки зрения бизнеса - достигнут описанный результат (1.2 что мы ожидаем от конкретной итерации).  

#### 1.2. Бизнес-требования и ограничения  

- Краткое описание БТ - система по введенному идентификатору покупателя должна вернуть ранжированный список рекомендаций, рекомендации должны обновляться еженедельно.
- Бизнес-ограничения - запрос должен обрабатываться не более 3х секунд 
- Что мы ожидаем от конкретной итерации (расписать недельные итерации из плана) 
